														...
														<div class="tab-content padding-4">
															...
															<div id="adminEdit" class="tab-pane in active ">
																<div class="scrollable-horizontal" data-size="800">
																   ${requestScope.dictionary_edit_msg }
																	<form action="${pageContext.request.contextPath }/dictionary/editDictionary" method="post" class="form-horizontal" role="form">
																	    <input name="dictionary_id" type="hidden" value="${requestScope.dictionary.dictionary_id }">
																			<div class="form-group">
																			<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 数据字典名 </label>

																			<div class="col-sm-9">
																				<input name="dictionary_name" value="${requestScope.dictionary.dictionary_name }" type="text" id="form-field-1" placeholder="数据字典名" class="col-xs-10 col-sm-5" />
																			</div>
																		</div>
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<input name="dictionary_value" value="${requestScope.dictionary.dictionary_value }" type="text" id="form-field-1" placeholder="数据字典值" class="col-xs-10 col-sm-5" />
																			</div>
																		</div>
																			...
																			<div class="col-sm-9">
																				<input name="dictionary_type_code" value="${requestScope.dictionary.dictionary_type_code }"  type="text" id="form-field-1" placeholder="字典类型编码" class="col-xs-10 col-sm-5" />
																			</div>
																		</div>
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<input name="dictionary_type_name" value="${requestScope.dictionary.dictionary_type_name }"  type="text" id="form-field-1" placeholder="字典类型名称" class="col-xs-10 col-sm-5" />
																			</div>
																		</div>
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-7 text-right">
																				<button type="submit" class="btn btn-primary">编辑数据字典</button>
																			</div>
																		</div>
																	</form>
