					...
					<div class="page-content">
				          			<div class="widget-box transparent" id="widget-box-13">
												<div class="widget-header">
													<h4 class="widget-title lighter">修改密码管理</h4>
													...
													<div class="widget-main padding-12 no-padding-left no-padding-right">
														<div class="tab-content padding-4">
															...
															<div id="setPassword" class="tab-pane in active">
															   ${user_edit_password_msg }
															   <form action="${pageContext.request.contextPath }/user/editPassword" class="form-horizontal" role="form">
																		<div class="form-group">
																			<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 原密码 </label>

																			<div class="col-sm-9">
																				<input name="source_password" type="password" id="form-field-1" placeholder="原密码" class="col-xs-10 col-sm-5" />
																			</div>
																		</div>
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<input name="new_password" type="password" id="form-field-1" placeholder="原密码" class="col-xs-10 col-sm-5" />
																			</div>
																		</div>
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<input name="confirm_password" type="password" id="form-field-1" placeholder="确认密码" class="col-xs-10 col-sm-5" />
																			</div>
																		</div>
																			<div class="form-group">
