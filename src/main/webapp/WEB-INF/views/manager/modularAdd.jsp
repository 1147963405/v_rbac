														...
														<div class="tab-content padding-4">
															...
															<div id="adminAdd" class="tab-pane in active ">
																<div class="scrollable-horizontal" data-size="800">
																   ${requestScope.modular_add_msg }
																	<form action="${pageContext.request.contextPath }/modular/addModular" method="post" class="form-horizontal" role="form">
																		<input type="hidden" name="formToken" value="${sessionScope.sessionToken }">
																		<input type="hidden" name="token.invoke" value="${pageContext.request.contextPath}/modular/toModularAdd">
																		<div class="form-group">
																			<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 模块名 </label>

																			<div class="col-sm-9">
																				<input name="modular_name" type="text" id="form-field-1" placeholder="模块名" class="col-xs-10 col-sm-5" />
																			</div>
																		</div>
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<input name="modular_sort" type="text" id="form-field-2" placeholder="排序序号" class="col-xs-10 col-sm-5" />
																			</div>
																		</div>
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-7 text-right">
																				<button type="submit" class="btn btn-primary">增加模块</button>
																			</div> 
																		</div>
																	</form>
