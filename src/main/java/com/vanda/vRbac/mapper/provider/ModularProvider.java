...
public class ModularProvider {
	...
	public String countByCondition(Map<String, Object> condition) {
		// 第一步：声明公共的SQL语句
		String sql = "SELECT count(1) FROM tb_basic_modular WHERE 1=1 ";
		// 第二步：构建动态SQL语句
	...
	public String updateForNotNull(Map<String, Object> modular) {
		...
		//2.构建SQL动态语句
		StringBuilder builder=new StringBuilder(sql);
		if (modular.get("modular_name")!=null) {
			builder.append("modular_name=#{modular_name},");
		}
		if (modular.get("modular_sort")!=null) {
	...
	public String delteByIds(Map<String, Object[]>  idsMap) {
		//获得参数中的ID
		Object[] modularIds = idsMap.get("array");
		//第一步：公共SQL
